                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mb-2 truncate max-w-md">{{ Str::limit($assignment->content, 80) }}</p>
                                <div class="flex flex-wrap items-center gap-4 text-sm">
                                    ...
                                    @elseif($assignment->due_date)
                                        <span class="{{ $isUrgent ? 'text-red-600 font-medium' : ($isExpired ? 'text-red-500 font-medium' : 'text-gray-500') }}">
                                            ...
                                            {{ $isExpired ? 'หมดเขตเมื่อ:' : 'ครบกำหนด:' }} {{ $assignment->due_date->format('d/m/Y H:i') }}
                                        </span>
                                    @endif
                                </div>
                            </div>
