<x-typing-app :role="'student'" :title="'ฝึกพิมพ์ - ' . $assignment->title">
        ...
        <div class="card p-8 mb-6 relative overflow-hidden min-h-[300px] flex flex-col justify-center text-lg md:text-xl leading-relaxed font-mono"
            ...
            <div x-show="!isFocused && !isStarted && !isFinished" 
                ...
                <div class="text-center animate-bounce">
                    <div class="w-16 h-16 bg-primary-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg text-white">
            ...
            <textarea 
                x-ref="typingInput"
                class="absolute inset-0 opacity-0 cursor-default resize-none z-10"
                @input="handleInput"
    ...
    <style>
        .font-mono {
            font-family: 'Courier Prime', 'Sarabun', monospace; /* Use a good monospaced font if available */
            line-height: 2;
        }
