            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">แดชบอร์ด</a>
                @else
                    <a href="{{ route('login') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">เข้าสู่ระบบ</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">สมัครสมาชิก</a>
                    @endif
                @endauth
            </div>
        @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">เอกสารอ้างอิง</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Laravel มีเอกสารที่ยอดเยี่ยมและครอบคลุมทุกด้านของเฟรมเวิร์ก
                                ไม่ว่าคุณจะเป็นมือใหม่หรือมีประสบการณ์มาก่อน เราขอแนะนำให้อ่านเอกสารประกอบตั้งแต่ต้นจนจบ
                            </p>
                        </div>
                    ...
                    <a href="https://laracasts.com"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Laracasts มีวิดีโอสอนการพัฒนาด้วย Laravel, PHP และ JavaScript นับพันรายการ
                                เข้าไปดูแล้วยกระดับทักษะการพัฒนาของคุณไปอีกขั้น
                            </p>
                        </div>
                    ...
                    <a href="https://laravel-news.com"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">ข่าวสาร Laravel</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Laravel News
                                คือข่าวสารจากคอมมูนิตี้และจดหมายข่าวที่รวบรวมข้อมูลล่าสุดและสำคัญที่สุดในระบบนิเวศของ
                                Laravel รวมถึงแพ็คเกจที่เพิ่งเปิดตัวและบทช่วยสอนต่างๆ
                            </p>
                        </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">ระบบนิเวศอันยอดเยี่ยม
                            </h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                เครื่องมือและไลบรารีชั้นนำของ Laravel เช่น <a href="https://forge.laravel.com"
                                ...
                                จะช่วยให้โปรเจ็คของคุณก้าวไปอีกระดับ ลองใช้ร่วมกับไลบรารีโอเพนซอร์สทรงพลังอย่าง <a
